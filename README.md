...
.login input[type="text"]:focus {
    /* Change background color when input is focused */
    background-color:rgb(90, 205, 96); /* Adjust the color as needed */
}
.join{
    padding: 10px 20px; /*  button size */
    background-color: #3498db;
...
<body >
    ...
    <h1>LEAF HUB WELCOMES YOU</h1>
    <h2>We have not much experience but have enough trust</h2>
    <h2>PRODUCTS</h2>
    <a href="sign.html">
    ...
    <h3>"People who need something really important they must know how what is the process to get it"</h3>
        ...
        <div class="login">
            <div class="login-box">
            <p style="color: rgba(240, 255, 252, 0.126);">DONT HAVE AN ACCOUNT</p>
            <a href="sign.html">
                <input type="button" value="SIGN IN"><br><br>
            </a>  
            <p style="color: rgba(240, 255, 247, 0.893);">LOGIN</p>
...
<footer style="background-color:darkmagenta;margin-top: 143; border: none;">
    <P style="color:#ffffff; ;"align="center">It Is Handled By Kavinilavan DK 23014025 </P>
</footer>
</html>
...
<html>
    ...
    <body>
        ...
        <center>
            <h1 >OUR HONARABLE PROJECTS</h1>
        <img src="it1.png" height="500" width="800">
    </center>
    </body>
    <footer style="background-color:rgb(139, 93, 0);margin-top: 64; border: none;">
        <P style="color:#ffffff; ;"align="center">It Is Handled By Kavinilavan DK 2023 </P>
    </footer>
</html>
...
<style>
    ...
    .styled form {
        ...
        .styled [type="submit"] {
            border-radius: 10px;
            padding: 5px 10px; /* button size */
            background-color: #e6edf2; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
...
<body>
    ...
    <div class="photos">
    <img src="photo1.jpg" height="200" width="180">
...
<div CLASS="names">
    <P>KAVINILAVAN</P>    
    <P style="margin-left: -45;">MICHEL</P>    
    <P>RAVANAN</P>    
    <P>MADDY</P>    
    <P>AADHI</P>    
    <P>HAASAN</P>    
...
<footer style="background-color:rgb(139, 104, 0);margin-top: 143; border: none;">
    <P style="color:#ffffff; ;"align="center">It Is Handled By Kavinilavan DK 23014025 </P>
</footer>
</html>
...
<body>
    ...
    <div class="form">
        <p align="center">ARE YOU HAVE WISH TO PART OF LEAF HUB</p>
        ...
        <label>Click the checkbox to see the magic of leaf</label>
...
<footer style="background-color:rgb(139, 110, 0);margin-top: 130px; border: none;">
    <P style="color:#ffffff ;"align="center">It Is Handled By Kavinilavan DK 23014025 </P>
</footer>
</html>
...
<body>
    ...
    <div class="company">
        <center>
        <h3 style="color: rgb(230, 229, 224);">COMPANY CONTACT INFORMATION</h3>
       <p> <b >Address</b></p>
        <p >ABC Street chennai</p>
        <p >Vikaravandi Post</p>
        <p >Chennai-600114</p>
        <b >Email:</b>
        <p >kavinilavan416@gmail.com</p>
        <b >Phone</b>
        <p >8667476550</p>
    </center>
    </div>
</body>
<footer style="background-color:rgba(58, 0, 139, 0.536);margin-top: 130px; border: none;">
    <P style="color:#ffffff ;"align="center">It Is Handled By Kavinilavan DK 23014025 </P>
</footer>
</html>
